...
JSEARCH_QUERIES = {
    1: ["Junior full stack remote", "full stack developer", "laravel developer remote"],
    2: ["nodejs developer remote", "nestjs developer remote"],
    3: ["back-end developer remote", "php developer remote"],
}

_DEFAULT_SKILLS = [
    "PHP", "Laravel", "JavaScript", "TypeScript",
    "node.js", "NestJS", "Microservices", "MySQL",
    "eloquent	ORM", "TypeORM", "Redis",
    "html", "cms", "Ethers.js", "Git", "Ajax"
]
...
BLACKLIST_KEYWORDS = [
    ...
    "senior", "head of", "director of", "vp of",
    "agency",
...
BOOST_KEYWORDS = {
    "Laravel": 20, "php": 18, "nodejs": 15,
    "junior": 18, "entry level": 15, "associate": 12,
    "TypeScript": 12, "Ethers.js": 12, "JavaScript": 10,
